...
import LekabSMS from './lekab.js';

const lekabSMS = new LekabSMS('a2JrOmNHVjBkR1Z5YVM1d1lXRnphV3QxYm01aGMwQnNaV3RoWWk1amIyMDpRZ21BRU9HRDRRYWJ6VE5x', 'https://secure.lekab.com/restsms/lekabrest');
...
export const sendSMSNode = createNodeDescriptor({
	...
	function: async ({ cognigy, config }: ISendSMSParams) => {
		...
		let result = null;
		try {
			const client = new lekabSMS(APIkey);
